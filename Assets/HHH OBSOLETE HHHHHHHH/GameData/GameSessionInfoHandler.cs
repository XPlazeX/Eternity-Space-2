...
public class GameSessionInfoHandler : MonoBehaviour
{
    ...
    public static bool IsSignalLevel => false;//GameObject.FindWithTag("BetweenScenes").GetComponent<MissionsDatabase>()._activeMissionSample.SignalLevel;
...
// DATA COLLECTIONS
    ...
    public static void ReplaceValueInCollection(string name, int index, int newValue)
    {
        ...
        _save.AdditiveData[name][index] = newValue;
        RewriteSessionSave(_save);
    }
