...
public class Clock : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        _hourHand.transform.eulerAngles = new Vector3(0, 0f, _hourHand.transform.eulerAngles.z - 360f * (ESTime.worldDeltaTime / 43200f) * _timeScale);
        _minuteHand.transform.eulerAngles = new Vector3(0, 0f, _minuteHand.transform.eulerAngles.z - 360f * (ESTime.worldDeltaTime / 3600f) * _timeScale);
        _secondHand.transform.eulerAngles = new Vector3(0, 0f, _secondHand.transform.eulerAngles.z - 360f * (ESTime.worldDeltaTime / 60f) * _timeScale);
        _miliSecondHand.transform.eulerAngles = new Vector3(0f, 0f, _miliSecondHand.transform.eulerAngles.z - (360f * ESTime.worldFixedDeltaTime * _timeScale));
