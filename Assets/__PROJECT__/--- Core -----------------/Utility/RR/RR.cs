...
public static class RR
{
    ...
    private static void SetHardcodedFallbackDefaults()
    {
        ...
        SetFallback(RuntimeStat.MainWeaponFirerateRandomizing, 1f, RuntimeStatGroup.Player);
        SetFallback(RuntimeStat.MainWeaponFlatSpread, 0f, RuntimeStatGroup.Player);
        SetFallback(RuntimeStat.MainWeaponPrepareTimeMultiplier, 1f, RuntimeStatGroup.Player);
    ...
    public sealed class RuntimeValues
    {
        ...
        public float MainWeaponFirerateRandomizing => Get(RuntimeStat.MainWeaponFirerateRandomizing);
        public float MainWeaponFlatSpread => Get(RuntimeStat.MainWeaponFlatSpread);
        public float MainWeaponPrepareTimeMultiplier => Get(RuntimeStat.MainWeaponPrepareTimeMultiplier);
